...
//! It also holds [`FILE_DISCOVERY_GUIDANCE`], which used to be a BASE block
//! but is NOT model-agnostic in the relevant sense — it names three concrete
//! tools, so it belongs to whichever agents actually carry them (#4602).
