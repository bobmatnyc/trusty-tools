<script lang="ts">
   ...
   * docs/design/UI/design-system/icons/RobotIcon.svelte (repo root). Fix a
   * bug or change the geometry there first, then propagate to this copy and
   * its ui-search/ui-memory/ui-analyze siblings, per that directory’s
   * README.md, until #3492 (`@trusty/foundry` package) replaces copy-paste
