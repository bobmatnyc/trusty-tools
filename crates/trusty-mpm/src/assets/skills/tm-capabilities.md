...
| Question | Load |
|---|---|
| "What are the exact `tm <command>` subcommands / flags?" | `references/cli.md` (53 top-level commands) |
...
| "What does a `tm doctor` check name actually mean?" | `references/doctor.md` (18 checks) |
