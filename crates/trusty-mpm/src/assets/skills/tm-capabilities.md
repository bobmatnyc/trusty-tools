...
| "What skills exist, and are they user-invocable?" | `references/skills.md` (56 bundled skills) |
| "What does a `tm doctor` check name actually mean?" | `references/doctor.md` (60 checks) |
