...
| Question | Load |
|---|---|
| "What are the exact `tm <command>` subcommands / flags?" | `references/cli.md` (59 top-level commands) |
| "What MCP tools exist and what parameters do they take?" | `references/mcp-tools.md` (34 tools, plus sibling-daemon pointers) |
...
| "What does a `tm doctor` check name actually mean?" | `references/doctor.md` (36 checks) |
