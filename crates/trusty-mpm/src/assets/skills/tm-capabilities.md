...
| Question | Load |
|---|---|
| "What are the exact `tm <command>` subcommands / flags?" | `references/cli.md` (64 top-level commands) |
...
| "What does a `tm doctor` check name actually mean?" | `references/doctor.md` (61 checks) |
