...
is this style's whole point, so the teaching narration stays. Teach the mechanism
("engineer owns the implementation, qa owns the proof"), never the play-by-play
of your own tool calls.
