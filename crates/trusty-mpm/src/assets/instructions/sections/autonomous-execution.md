<!-- #8361: carved out of `core.md` so a project can retune the PM's comfort
     level. `core` is tier `fixed` and admits no override, so while this lived
     there a resume skill and this rule could contradict each other with no way
     for a project to settle it. -->
