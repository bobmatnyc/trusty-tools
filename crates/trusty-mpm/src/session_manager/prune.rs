...
// #7965: the sweep's own gates moved to `prune_orphan_sweep.rs` with its body.
use super::worktree_safety::{DirtyWorktree, DirtyWorktreePolicy, inspect_dirt};

#[path = "prune_types.rs"]
mod types;

// #7965: the orphaned-worktree sweep, split out when its blocking work moved
// off the async runtime.
#[path = "prune_orphan_sweep.rs"]
mod orphan_sweep;
