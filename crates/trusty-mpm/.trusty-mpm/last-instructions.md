...
### api-qa
- **Role:** qa
- **Handles:** Specialized API and backend testing for REST, GraphQL, and server-side functionality
- **Model:** sonnet

### code-analyzer
- **Handles:** Code analysis specialist. Reviews code for correctness, quality, security, and architectural health using static analysis.
- **Model:** sonnet

### code-critic
- **Role:** qa
- **Handles:** Adversarial code review using a structured rubric. Outputs APPROVE/WARN/BLOCK verdict with line-level citations. Independent of implementer to avoid anchoring bias.
- **Model:** sonnet

### dart-engineer
- **Role:** engineer
- **Handles:** Specialized Dart/Flutter engineer for cross-platform mobile, web, and desktop development with modern null safety and state management
- **Model:** sonnet

### data-engineer
- **Handles:** Data transformation specialist. Builds ETL pipelines, performs database migrations, and processes large datasets efficiently.
- **Model:** sonnet

### documentation
- **Handles:** Documentation specialist. Creates, reorganises, and maintains technical documentation with consistency across the project.
- **Model:** haiku

### dotnet-engineer
- **Role:** engineer
- **Handles:** Modern C#/.NET 8+ specialist: ASP.NET Core, EF Core, xUnit, nullable reference types, minimal APIs, async/await — plus legacy VB.NET maintenance awareness
- **Model:** sonnet

### engineer
- **Handles:** General-purpose software engineer. Implements features, fixes bugs, refactors code.
- **Model:** sonnet

### gcp-ops
- **Role:** ops
- **Handles:** Specialized agent for Google Cloud Platform operations, authentication, and resource management
- **Model:** sonnet

### golang-engineer
- **Role:** engineer
- **Handles:** Go 1.23-1.24 specialist: concurrent systems, goroutine patterns, interface-based design, high-performance idiomatic Go
- **Model:** sonnet

### java-engineer
- **Role:** engineer
- **Handles:** Java 21+ LTS specialist delivering production-ready Spring Boot applications with virtual threads, pattern matching, modern performance optimizations, and comprehensive JUnit 5 testing
- **Model:** sonnet

### javascript-engineer
- **Role:** engineer
- **Handles:** Vanilla JavaScript specialist: Node.js backend (Express, Fastify, Koa), browser extensions, Web Components, modern ESM patterns, build tooling
- **Model:** sonnet

### local-ops
- **Role:** ops
- **Handles:** Local development environment specialist for process supervision, Docker, database lifecycle, and quality gates
- **Model:** sonnet

### memory-manager
- **Handles:** Manages project memory via the trusty-memory MCP backend — store, recall, tag, and prune facts using domain-aware organisation
- **Model:** haiku

### mpm-agent-manager
- **Handles:** Manages agent lifecycle in trusty-mpm — discovery, validation, bundled-asset deployment, and contribution workflow for the agent catalog
- **Model:** sonnet

### mpm-skills-manager
- **Handles:** Manages skill lifecycle in trusty-mpm — discovery, deployment, tech-stack-based recommendations, and contribution workflow for the skills catalog
- **Model:** sonnet

### nextjs-engineer
- **Role:** engineer
- **Handles:** Next.js 15+ specialist: App Router, Server Components, Partial Prerendering, performance-first React applications
- **Model:** sonnet

### ops
- **Handles:** Local operations specialist for deployment, DevOps, and process management. Manages environments, services, and quality gates.
- **Model:** sonnet

### phoenix-engineer
- **Role:** engineer
- **Handles:** Elixir/Phoenix specialist for building web applications, APIs, and LiveView experiences with solid OTP and Ecto foundations
- **Model:** sonnet

### php-engineer
- **Role:** engineer
- **Handles:** PHP 8.4-8.5 + Laravel 11-12 specialist: strict types, modern security (WebAuthn/passkeys), performance-first applications
- **Model:** sonnet

### prompt-engineer
- **Role:** engineer
- **Handles:** Expert prompt engineer specializing in LLM optimization: model selection, extended thinking, tool orchestration, structured output, and context management. Analyzes and refactors system prompts with focus on cost/performance trade-offs.
- **Model:** sonnet

### python-engineer
- **Role:** engineer
- **Handles:** Python 3.12+ development specialist: type-safe, async-first, production-ready implementations with SOA and DI patterns
- **Model:** sonnet

### qa
- **Handles:** Expert quality assurance engineer. Designs test strategies, implements automation, and validates software quality.
- **Model:** sonnet

### react-engineer
- **Role:** engineer
- **Handles:** Specialized React development engineer focused on modern React patterns, performance optimization, and component architecture
- **Model:** sonnet

### refactoring-engineer
- **Role:** engineer
- **Handles:** Safe, incremental code improvement specialist focused on behavior-preserving transformations with comprehensive testing
- **Model:** sonnet

### research
- **Handles:** Expert research analyst. Investigates codebases, maps architectures, assesses technology stacks, and captures structured findings.
- **Model:** sonnet

### ruby-engineer
- **Role:** engineer
- **Handles:** Ruby 3.4 + YJIT + Rails 8 specialist: 30% faster method calls, Kamal deployment, service objects, production-ready Rails applications
- **Model:** sonnet

### rust-engineer
- **Role:** engineer
- **Handles:** Rust 2024 edition specialist: memory-safe systems, zero-cost abstractions, ownership/borrowing mastery, async patterns with tokio. Defers all pattern decisions to the toolchains-rust-core skill.
- **Model:** sonnet

### security
- **Handles:** Security specialist. Performs vulnerability assessment, attack vector detection, secret scanning, and compliance review.
- **Model:** sonnet

### svelte-engineer
- **Role:** engineer
- **Handles:** Specialized agent for modern Svelte 5 (Runes API) and SvelteKit development. Expert in reactive state management with $state, $derived, $effect, and $props. Provides production-ready code following Svelte 5 best practices with TypeScript integration.
- **Model:** sonnet

### tauri-engineer
- **Role:** engineer
- **Handles:** Tauri desktop application specialist: hybrid web UI + Rust backend, IPC patterns, state management, system integration, cross-platform development with <10MB bundle sizes
- **Model:** sonnet

### ticketing
- **Handles:** Ticket management specialist. Creates, updates, and tracks issues with scope validation, scope-aware linking, and workflow state intelligence.
- **Model:** haiku

### typescript-engineer
- **Role:** engineer
- **Handles:** TypeScript 5.6+ specialist: strict type safety, branded types, performance-first, modern build tooling
- **Model:** sonnet

### vercel-ops
- **Role:** ops
- **Handles:** Vercel platform operations specialist for deployment, edge functions, environment management, and serverless architecture
- **Model:** sonnet

### version-control
- **Handles:** Git operations specialist. Manages branches, versioning, releases, and merge conflict resolution with clean history.
- **Model:** haiku

### web-qa
- **Role:** qa
- **Handles:** Progressive 6-phase web testing with UAT mode for business intent verification, behavioral testing, and comprehensive acceptance validation alongside technical testing
- **Model:** sonnet

### web-ui-engineer
- **Role:** engineer
- **Handles:** Front-end web specialist with expertise in HTML5, CSS3, JavaScript, responsive design, accessibility, and user interface implementation
- **Model:** sonnet
