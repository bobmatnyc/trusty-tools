...
/// Test: `start_lock_lives_beside_the_addr_file`;
/// `n_concurrent_bridges_start_exactly_one_daemon` in
/// `crates/trusty-common/tests/single_flight_exclusion.rs` proves the exclusion.
