...
/// plus the pane-level regression
/// `granted_ids_exclude_l0_and_exfil_skills_under_a_wildcard_allow` in
/// `api::server::agent_skills::unit_tests` — `granted_skill_ids` is the only
/// pane whose output this changes.
