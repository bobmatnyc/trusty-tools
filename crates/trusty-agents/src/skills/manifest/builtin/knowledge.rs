...
pub(super) static TABLE: &[SkillDef] = &[
    ...
    tool_skill(
        ...
        "Memory Search (Native)",
        "Recall durable facts from this assistant’s trusty-memory namespace.",
        "search_memory",
        Knowledge,
        None,
    ),
    ...
    tool_skill(
        "durable-memory-write-alias",
        "Persist a Fact",
        "Write a durable fact to this assistant's own memory namespace.",
        "memory_write",
        Knowledge,
        None,
    ),
