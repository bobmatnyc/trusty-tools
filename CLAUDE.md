...
error contracts, and cross-crate surfaces; a single-line doc or lightweight pattern
suffices for trivial items (simple getters, obvious one-liners, thin re-exports).
