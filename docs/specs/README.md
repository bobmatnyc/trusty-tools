...
| DOC-49 | `SPEC-TTUI-01~draft` … `-09~draft` | [trusty-code Interactive TUI: Claude Code Clone over Shared REPL Layer](./DOC-49-tcode-tui-claude-code-clone.md) | trusty-code — interactive terminal UI thin client; trusty-tui shared crate (ratatui REPL extraction from trusty-agents) |
...
> **Next free `DOC-N` = `DOC-50`** (re-scan of the whole `docs/` tree, 2026-07-20): the
> highest cataloged number is now **DOC-49** ([trusty-code Interactive TUI](./DOC-49-tcode-tui-claude-code-clone.md),
