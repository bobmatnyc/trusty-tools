...
| DOC-76 | `SPEC-TCPARITY-01~draft` … `-04~draft` | [trusty-code TUI vs Claude Code: Interactive-Loop Parity Map](./DOC-76-tcode-tui-claude-code-parity-map.md) | `trusty-code` — `tcode tui`, `trusty-code-tui` shared REPL crate, `tui_client::engine`. The full Claude Code parity comparison behind [DOC-75](./DOC-75-tcode-tui-mvp-parity.md)'s milestone-87 cut; records the parity baseline ruling (trusty-mpm, not vanilla Claude Code, for instruction-adherence comparisons) and the retargeting of [#8208](https://github.com/bobmatnyc/trusty-tools/issues/8208)/[#8209](https://github.com/bobmatnyc/trusty-tools/issues/8209) to `trusty-agents` |
...
> [trusty-code TUI vs Claude Code: Interactive-Loop Parity Map](./DOC-76-tcode-tui-claude-code-parity-map.md),
