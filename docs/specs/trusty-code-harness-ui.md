...
- **2026-07-19** — **Workstream-first entry amendment** (issue #3365, Phase C). Amends §7A
  ...
  submitting mints+activates a workstream before running the first task bound to it
  (superseding item 3/AC-21.4's "session is created… as a side effect" framing). Sessions
  remain the internal execution unit (§3.1, §4B), never renamed or re-scoped by this
  amendment. Documents the projectless↔unbound-session mapping the modal's "start
