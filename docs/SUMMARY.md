...
- [Getting Started](./getting-started/README.md)
  - [Install and Run `tm`](./getting-started/install-and-run-tm.md)
  - [Claude MPM and Trusty MPM](./getting-started/claude-mpm-vs-trusty-mpm.md)
- [Workspace Package and Code Map](./reference/crate-map.md)
- [Documentation Layout and Authority](./reference/documentation-layout.md)

# Contracts and Decisions

- [Behavior-Contract Specifications](./specs/README.md)
- [Architecture Decision Records](./adr/README.md)
  - [ADR Process and Template](./adr/template.md)

# Product Documentation

- [trusty-mpm](./trusty-mpm/README.md)
- [trusty-agents](./trusty-agents/README.md)
- [trusty-code](./trusty-code/README.md)
- [trusty-search](./trusty-search/README.md)
...
- [Configuration Convention](./reference/config-convention.md)
...
- [Port Assignments](./architecture/port-assignments.md)
- [Audit Instructions](./guides/audit-instructions.md)
- [Documentation Inventory — 2026-09-02](./audits/2026-09-02-documentation-inventory.md)
