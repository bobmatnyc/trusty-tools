...
- **Status:** Amended by [0019](0019-unified-ipc-messaging-on-event-bus.md)
- **Date:** 2026-06-06
- **Scope:** Workspace-wide (`trusty-agents-common` foundation; future consumers `trusty-agents`, `trusty-mpm`, `trusty-code`)
- **Supersedes / Superseded by:** Builds on ADR-0004. ADR-0019 amends only
  the "MessageBus stays separate" rule; this ADR's telemetry envelope and
  event-bus foundation remain in force.
