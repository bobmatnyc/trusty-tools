 ...
 * What: fixture cases for each grammar deviation. Nothing here reads the
 * repository — the cases that parse the real corpus, including the trap in
 * `trusty-search`'s own file, live in `parse.corpus.test.ts` (#8272).
 * Test: this file.
 */
